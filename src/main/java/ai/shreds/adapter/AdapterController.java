...
public class AdapterController {
    ...
    public ResponseEntity<AdapterResponseDTO> storeSupplierTransaction(@Valid @RequestBody AdapterRequestParams params) {
        try {
            ...
            AdapterResponseDTO responseDTO = applicationStoreSupplierTransactionInputPort.storeSupplierTransaction(domainSupplierTransaction);
            return new ResponseEntity<>(responseDTO, HttpStatus.CREATED);
        } catch (Exception e) {
            throw new CustomException("An error occurred while storing supplier transaction: " + e.getMessage());
        }
    }
     ...
     */
    @Data
    public static class AdapterRequestParams {
        @NotNull
     ...
     */
    @Data
    public static class AdapterProductTransactionRequest {
        @NotNull
     ...
     */
    @Data
    public static class AdapterResponseDTO {
        private UUID id;
        private UUID supplierId;
        private LocalDateTime transactionDate;
     ...
     */
    public static class AdapterSupplierTransactionMapper {
        public DomainSupplierTransaction toDomain(AdapterRequestParams request) {
            ...
            domainSupplierTransaction.setProducts(new AdapterProductTransactionMapper().toDomain(request.getProducts()));
     ...
     */
    public static class AdapterProductTransactionMapper {

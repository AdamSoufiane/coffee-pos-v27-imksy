package ai.shreds.infrastructure; 
 ...
 import org.springframework.kafka.support.serializer.SerializationException; 
 ...
 public class InfrastructureKafkaConfig { 
     ...
     public ProducerFactory<String, Object> producerFactory() { 
         ...
         configProps.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, ErrorHandlingSerializer.class); 
         configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, ErrorHandlingSerializer.class); 
         configProps.put(ErrorHandlingSerializer.VALUE_DESERIALIZER_CLASS, JsonSerializer.class); 

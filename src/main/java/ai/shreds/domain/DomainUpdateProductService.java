package ai.shreds.domain; 
 ...
 public class DomainUpdateProductService implements DomainProductUpdatePort { 
     ...
     private final InfrastructureKafkaProducer kafkaProducer; // Add Kafka Producer 
 ...
 // Implementation Note: Use Lombok annotations for getters and setters in DomainProductEntity and DomainInventoryEntity.
...
import shared.AdapterCreateProductRequest;
import shared.AdapterUpdateProductRequest;
import adapter.AdapterProductResponse;
import adapter.AdapterProductMapper;
...
public class DomainProductService {
    ...
    public DomainProductEntity createProduct(AdapterCreateProductRequest request) {
        DomainProductEntity product = AdapterProductMapper.mapToDomainEntity(request);
